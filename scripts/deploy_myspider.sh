...
#firewall-cmd --zone=public --add-port=6800/tcp --permanent  #scrapyd spiderserver
#firewall-cmd --zone=public --add-port=5000/tcp --permanent  #spiderkeeper scrapydmanager
firewall-cmd --reload
